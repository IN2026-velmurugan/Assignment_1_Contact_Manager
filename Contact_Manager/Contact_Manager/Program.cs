...
SortedList<string, ContactsInfo> contactInfo = new SortedList<string, ContactsInfo>();
List<ContactsInfo> contactsList = new List<ContactsInfo>();
...
void HandleChoice(string choice)
{
    ...
    {
        case "S":
            new Functionalities().ViewContacts(contactsList);
            break;
        case "A":
