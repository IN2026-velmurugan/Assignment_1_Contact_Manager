...
namespace ContactManager
{
    ...
    {
        public void ViewOrSearchContacts(List<ContactsInfo> contactsList)//Method to view or search contact
        {
        ...
        public void DisplayAllContacts(List<ContactsInfo> contactsList)//Method to display all contacts
        {
        ...
        public void UpdateContact(List<ContactsInfo> contactsList)//Method to update contact
        {
            if (new Utilities().listIsEmpty(contactsList)) return;
            DisplayAllContacts(contactsList);
            Console.WriteLine();
        ...
        public void DeleteContact(List<ContactsInfo> contactsList)//Method to delete contact
        {
            if (new Utilities().listIsEmpty(contactsList)) return;
            DisplayAllContacts(contactsList);
            Console.WriteLine();
